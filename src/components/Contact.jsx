...
emailjs.send('service_h8slp7x','template_9j8xvff',
{from_name:form.name,to_name:'Shreya',from_email:'form.email',to_email:'singalshreya97@gmail.com',message:form.message},
'JEtKif0ZtdUF57Z3N'
)
.then(()=>{
  setLoading(false)
